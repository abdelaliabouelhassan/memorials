            ...
            <div class=" w-full space-y-4 pt-14 ">
               <div class="relative w-full">
                    <input
                        ...
                        placeholder="" id="firstname" name="firstname" /><label for="firstname"
                ...
                <div class=" w-full py-4">
                      <button class=" uppercase text-white bg-primary rounded-md hover:scale-x-110 duration-200 w-full py-2 font-Altivo text-lg">Register</button>
                </div>
