    ...
    <div class=" w-full h-full flex py-4 px-4">
        <div class=" m-auto space-y-4 w-full max-w-sm">
            <div class=" flex flex-col items-start space-y-2">
                <h1 class=" text-[#524C57] text-2xl font-Altivo font-normal">{{$t('welcome')}}</h1>
                <span class=" text-[#87848B] text-lg font-Inter font-normal">{{$t('please_sign_up')}}</span>
            </div>
            ...
            <div class=" w-full space-y-4 pt-14 ">
                <div class=" flex flex-col items-start">
                    ...
                    <div class="relative w-full">
                        ...
                        v-model="form.first_name"
                            ...
                            placeholder="" id="firstname" name="firstname" />
                            <label for="firstname"
               ...
               <div class=" flex flex-col items-start">
                ...
                <div class=" w-full py-4">
                      <button :disabled='loading' @click="register" class=" uppercase text-white bg-primary rounded-md hover:scale-x-110 duration-200 w-full py-2 font-Altivo text-lg">
                ...
                <div class="  w-full flex">
                    <p class=" m-auto text-[#87848B] text-lg font-Altivo font-normal">
                        ...
                        <router-link to="/login" class=" text-primary p-2">{{$t('login')}}</router-link>
                    </p>
                </div>
...
const register = () => {
    ...
    success.value = false
    loading.value = true
    axios.post('/auth/register',form.value).then((res) => {
        console.log(res)
        success.value = true
