    ...
    <div class=" w-full absolute top-0  md:border  left-0 p-4 z-20 backdrop-blur-xl" :class="{'bg-white':theme != 'dark'}">
        <div class=" w-full  items-center justify-between  md:hidden flex">
            ...
            <button @click="openMenu">
                <svg v-if="!open" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-9 h-9 md:text-primary" :class="{' text-white':theme == 'dark'}">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
                </svg>
                <svg v-else xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-9 h-9 md:text-primary" :class="{' text-white':theme == 'dark'}">
