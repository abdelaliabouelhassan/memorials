<template>
    <div class=" w-full flex items-center  md:border justify-between absolute z-20 -bottom-[0.1rem] bg-white py-7 md:py-4 px-4">
        ...
        <a href="https://www.instagram.com/seelenstein" target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class=" w-6 h-6 text-primary " viewBox="0 0 16 16">
        ...
        <a href="https://www.tiktok.com/@meinseelenstein" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class=" w-6 h-6 text-primary" viewBox="0 0 16 16">
